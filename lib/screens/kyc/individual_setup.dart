...
class KycIndividualSetup extends StatefulWidget {
  const KycIndividualSetup({super.key});

  @override
  State<KycIndividualSetup> createState() => _KycIndividualSetupState();
}

class _KycIndividualSetupState extends State<KycIndividualSetup> {
  @override
  void initState() {
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_)async{
      // SKIP TO LAST STEP USER WAS IN
      await Provider.of<KycIndividualProvider>(context,listen: false).getCurrentStep();
  ...
  Widget build(BuildContext context) {
    return Consumer2<KycIndividualProvider,AuthProvider>(
