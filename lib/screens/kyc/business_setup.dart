...
class KycBusinessSetup extends StatefulWidget {
  const KycBusinessSetup({super.key});

  @override
  State<KycBusinessSetup> createState() => _KycBusinessSetupState();
}

class _KycBusinessSetupState extends State<KycBusinessSetup> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_)async{
      ...
      await Provider.of<KycBusinessProvider>(context,listen: false).getCurrentStep();
