            ...
            children: [
              ...
              kyc.userKycs.where((el)=>el.docType==Strings.selfie).isEmpty&&
                  ...
                  buildLogoPickerBox(context,
                      onTap: ()async{
                        // pick logo
                        await Provider.of<TukuBusinessKycProvider>(context,listen: false).pickLogo();
                        await Provider.of<TukuBusinessKycProvider>(context,listen: false).submitLogo(context);
                        await Provider.of<TukuBusinessKycProvider>(context,listen: false).nextStep();
                      })
                  :Column(
                children: [
                  ClipRRect(
