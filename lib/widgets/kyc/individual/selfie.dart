...
class Selfie extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer2<KycIndividualProvider,CameraProvider>(
          ...
          child: Column(
            ...
            children: [
              ...
              buildSelfieCaptureBox(
                  context, onTap: () {
                Provider.of<KycIndividualProvider>(context,listen: false).setIsSelfie();
                  ...
                  ElevatedButton(
                    onPressed: ()async{
                      if(!kyc.deletingKyc){
                        ...
                        await Provider.of<KycIndividualProvider>(context,listen: false).deleteKyc(selfieKycId,context);
                        Navigator.pushNamed(context, Routes.capture);
                      }
                    },
