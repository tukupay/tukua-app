      ...
      builder: (_,kyc,__) {
        return InkWell(
          onTap: ()async{
            ...
            bool picked=await Provider.of<KycBusinessProvider>(context,listen: false).pickBusinessCert();
           if(picked==true){
             await Provider.of<KycBusinessProvider>(context,listen: false).submitBusinessCert(context);
           }
          },
                ...
                :kyc.userKycs.firstWhere((el)=>el.docType==Strings.businessCert).certNumber==null?
                    BusinessAnalysisError(
                      ...
                      pressed: ()async{
                        ...
                        bool deleted=await Provider.of<KycBusinessProvider>(context,listen: false).deleteKyc(kycId, context);
                       if(deleted){
                         // pick another file
                         bool picked=await Provider.of<KycBusinessProvider>(context,listen: false).pickBusinessCert();
                         if(picked==true){
