...
class IndividualSuccessAnalysis extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<TukuIndividualKycProvider>(builder: (_, kycProvider, __) {
      return Container(
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: () async {
                          final success = await Provider.of<TukuIndividualKycProvider>(context, listen: false).deleteKyc(kyc.kycId!, context);
                          if(success && context.mounted){
                            if(!isFront){
                              Provider.of<TukuIndividualKycProvider>(context, listen: false).resetIsFrontId();
                            } else {
                              Provider.of<TukuIndividualKycProvider>(context, listen: false).setIsFrontId();
                            }
