...
class SelectedContributionMethod extends StatelessWidget {
  const SelectedContributionMethod({super.key});

  @override
  Widget build(BuildContext context) {
    return Consumer2<FundraiserProvider, PaymentsProvider>(
      builder: (_, fundraiserProvider, payments, __) {
        final selectedMethod = fundraiserProvider.selectedContributionMethod;
        ...
        return SelectedMethodCard(
          ...
          fallbackIcon: HugeIcons.strokeRoundedMoneyReceive01,
          onTap: () {
            showModalBottomSheet(
              ...
              builder: (givingContext) {
                return DecoratedSheet(
                  ...
                  body: GivingPaymentOptions(isChanging: true),
                  height: 480,
                );
              },
            );
