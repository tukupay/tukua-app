  ...
  Widget build(BuildContext context) {
    return MultiProvider(
        providers: [
          ...
          ChangeNotifierProvider(create: (context)=>TukuIndividualKycProvider()),
          ChangeNotifierProvider(create: (context)=>TukuBusinessKycProvider()),
          ChangeNotifierProvider(create: (context)=>SasaIndividualKycProvider()),
          ChangeNotifierProvider(create: (context)=>SasaBusinessKycProvider()),
          ChangeNotifierProvider(create: (context)=>SasaPaymentsProvider()),
