    ...
    <View style={styles.root}>
      ...
      {loading ? (
        ...
        <ModuleEmpty
          ...
          description="Your admin must assign class × subject workloads before you can enter marks here."
        />
      ) : noLaForClass ? (
        <ModuleEmpty
          title="No subjects for this class"
          description="This class is not on your teacher workload. Pick another class or ask admin to add your learning areas."
        />
      ) : !subjectId ? (
        <ModuleEmpty
          title="Pick a learning area"
          description="Select the subject you teach for this class, then enter marks for each student."
        />
